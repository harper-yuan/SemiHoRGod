...
void benchmark(const bpo::variables_map& opts) {
  ...
  SemiHoRGod::utils::LevelOrderedCircuit circ;
  if(gate_type == "kMul") {
...
bpo::options_description programOptions() {
  ...
  desc.add_options()
    ...
    ("cm-threads", bpo::value<size_t>()->default_value(25), "Number of threads for communication.")
    ("cp-threads", bpo::value<size_t>()->default_value(25), "Number of threads for computation.")
